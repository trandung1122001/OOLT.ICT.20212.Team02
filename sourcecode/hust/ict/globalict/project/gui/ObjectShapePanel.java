	...
	public ObjectShapePanel(JFrame mainFrame) {
		...
		Cube.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				Point pos = new Point(e.getLocationOnScreen().x - offset.x - 50, e.getLocationOnScreen().y- offset.y - 50);
		...
		CreateObjectPramPanel(mainFrame, selected);
	}

	void CreateObjectPramPanel(JFrame mainFrame, JLabel selected) {
